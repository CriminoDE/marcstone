...
const SPELL_ELEMENT: Record<string, SpellElement> = {
  ...
  m_wrath: "shadow", m_curse: "shadow", m_runeshift: "arcane", m_bann: "shadow",
};
...
const FFA_TARGETED_SPELLS = new Set(["arc_shot", "fireball", "meteor", "pyroblast", "heal_touch", "mind_control", "m_curse", "m_bann"]);
